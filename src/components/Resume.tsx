  ...
  return (
    <section id="resume" className="resume-section">
      <div className="resume-container">
        ...
        >
          <a href="/Jay_Thesiya_Resume_Java_Developer.pdf" download="Jay_Thesiya_Resume_Java_Developer.pdf" className="download-btn">
            <Download size={20} />
            Download Resume
          </a>
        </motion.div>
        ...
        >
          ...
          >
            ...
            📩 thesiyajay54@gmail.com | 📱 +91 8866246898
          </motion.p>
